...
A fello redditor has detailed on how to make your own themes and how to apply them on stock os, the stock mod os on the other hand has a theme manager, so you can just use that to install the theme as a zip
